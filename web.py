...
def get_prediction(age, jobSatisfaction, monthlyIncome, yearsSinceLastPromotion,
                     department, gender, jobRole, maritalStatus):
    
    d_i, g_i, jr_i, ms_i = -1,-1,-1,-1
...
def predict():
    ...
    prediction = get_prediction(age, jobSatisfaction, monthlyIncome, 
